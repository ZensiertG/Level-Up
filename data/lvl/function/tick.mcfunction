...
execute as @a if score lvl_Setting lvl_Mining matches 1 if score @s lvl_MineBlocks >= Mining_2 lvl_Requirements run advancement grant @s only zensiert:zensiert/utility/mining_2
execute as @a if score lvl_Setting lvl_Mining matches 1 if score @s lvl_MineBlocks >= Mining_3 lvl_Requirements run advancement grant @s only zensiert:zensiert/utility/mining_3
